...
float piecePositioning(uint64_t *board) {
    ...
    positionScore += 100 * (oneNumber(board[8] & center) - oneNumber(board[14] & center)); // Padati in center
    positionScore += 4 * (oneNumber(board[8] & middle) - oneNumber(board[14] & middle)); // Padati in middle
